    ...
    this.state = {
      dataSource: ds.cloneWithRows(
          [
             ...
             {title: '乐天赞助韩国冬奥会6百亿！韩国人膨胀：中国队有本事别参加', origin: '咖谱网络',  image: require('../images/h_7.png')},
    ...
    return (
          <Button onPress={()=>{}}>  
                <View style={[styles.wrap ,{flexDirection: 'row'}]}>
                    <View style={{flex: 1}}>
                        <Image source={rowData.image} style={{width: 90, height: 76}} />
                    </View>
                    <View  style={{flex: 2, justifyContent: 'space-between', paddingLeft: px2dp(10)}}>
                        ...
                        <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                          ...
                          <Text style={styles.ad} onPress={()=>{}}>{rowData.origin}</Text>
                        </View>
                    </View>
                </View>
          </Button>
